...
VERSION="v0.1.0-dev-preview"
CHANNEL="codex-macos"
RELEASE_NAME="azai-token-pet-${VERSION}-${CHANNEL}"
...
copy_into_stage "docs/v1-dev-preview-package.md"
copy_into_stage "docs/v1-dev-preview-release-notes.md"
copy_into_stage "docs/v1-known-limitations-and-feedback.md"
copy_into_stage "docs/v1-codex-publish.md"
copy_into_stage "docs/v1-validation-2026-04-08-round-03.md"
