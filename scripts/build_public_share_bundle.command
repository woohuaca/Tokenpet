...
copy_into_stage "PUBLIC_DISTRIBUTION.md"
copy_into_stage "PRIVACY.md"
copy_into_stage "TERMS.md"
...
copy_into_stage "scripts/build_codex_release_bundle.command"
...
说明:
- 该包不包含你的本地 runtime 状态、日志和缓存事件
- 官方公共 Codex Plugin Directory 自助发布当前尚未开放
EOF

cd "$BUILD_ROOT"
ditto -c -k --sequesterRsrc --keepParent "$RELEASE_NAME" "$ARCHIVE_PATH"

echo "Built public share bundle:"
echo "$ARCHIVE_PATH"
